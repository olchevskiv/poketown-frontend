...
const MenuItemCard = ({menuItem,showPriceCalories=true}: Props) => {
    ...
    return (
        <div  onClick={menuItemRoute} className="py-5 md:py-10 h-[520px] flex flex-col justify-stretch items-center rounded-xl hover:border hover:border-primary-foreground bg-muted hover:bg-background px-10" >
            <img className="pb-5 pt-5 md:w-11/12 w-3/5 max-h-[370px]" src={menuItem.image_url}></img>
            <div >
